...
fprintf('With confidence of .95, a10 lies within %1.6f < %1.6f < %1.6f with an error of %1.4f%%\n',CIL(1),meanbb(1),CIH(1),errorr(1))
fprintf('With confidence of .95, a12 lies within %1.6f < %1.6f < %1.6f with an error of %1.4f%%\n ',CIL(2),meanbb(2),CIH(2),errorr(2))
fprintf('With confidence of .95, a21 lies within %1.6f < %1.6f < %1.6f with an error of %1.4f%%\n',CIL(3),meanbb(3),CIH(3),errorr(3))
fprintf('With confidence of .95, a20 lies within %1.6f < %1.6f < %1.6f with an error of %1.4f%%\n',CIL(4),meanbb(4),CIH(4),errorr(4))